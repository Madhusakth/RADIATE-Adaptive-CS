...
def train(model_name, root_dir, dataset_mode, max_iter):
    ...
    def get_radar_dicts(folders):
        ...
        for folder in folders:
            radar_folder = os.path.join(root_dir, folder, 'train_100')
    ...
    folders_train = ['city_1_3']#,'city_3_7','fog_6_0','fog_8_1']
    folders_test = ['city_1_3']
    ...
    cfg.SOLVER.BASE_LR = 0.000025# 0.000025 #0.00025
