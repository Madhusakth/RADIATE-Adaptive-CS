...
def get_radar_dicts(folders,radar_frame_no):
        ...
        for folder in folders:
            ...
            radar_frame = [radar_frame_no]
            for frame_number in radar_frame: #range(len(radar_files)):
                record = {}
                objs = []
                bb_created = False
                idd += 1
...
for i in range(20):
    ...
    DatasetCatalog.register(dataset_test_name,
                            lambda: get_radar_dicts(folders_test,i))
