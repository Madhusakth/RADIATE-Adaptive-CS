...
parser.add_argument("--test_folder", help="Folder to test",
                    default='tiny_foggy',
                    type=str)

parser.add_argument("--img_folder", help="image folder to test",
                    default='Navtech_Cartesian',
                    type=str)
...
def get_radar_dicts(folders):
        ...
        for folder in folders:
            radar_folder = os.path.join(root_dir, folder,args.img_folder)
