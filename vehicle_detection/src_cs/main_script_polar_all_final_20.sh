...
scenes='motorway_2_2 snow_1_0 tiny_foggy'


#scene="night_1_4"
folder='20-final-rad-info-polar-track-14'
sr=20
for scene in $scenes
do
for i in {2..21}
do
   ...
   python3 script_peak_detect_track_polar.py --npy_name=$prev --scene=$scene --sr=$sr
