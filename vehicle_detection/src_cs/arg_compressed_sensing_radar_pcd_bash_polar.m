...
function compressed_sensing_radar_pcd_bash_polar(k,scene)
    ...
    saveDir= char(strcat(myDir,'/20-final-rad-info-polar/'));
    ...
    if uniform == 0
    	...
    	Other = 240 - Imp
    	A1 = optimvar('A1','LowerBound', 0.2, 'UpperBound',0.4);
