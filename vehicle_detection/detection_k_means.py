...
radar_path = 'Navtech_Cartesian' #'Navtech_Cartesian_20' #'final-rad-info' #'reconstruct/reshaped' #'Navtech_Cartesian'
...
saveDir = root_path+ sequence_name + '/' + radar_path + '_k_means'
...
for t in ids:
    ...
    if output != {}:
        ...
        str_format = '{:06d}'
        radar_save_path = os.path.join(saveDir, str_format.format(t) + '.png')
