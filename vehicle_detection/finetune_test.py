...
cfg.MODEL.WEIGHTS = 'train_results/faster_rcnn_R_50_FPN_3x_good_and_bad_weather_005lr_4bs/model_final.pth' 
cfg.MODEL.ROI_HEADS.NUM_CLASSES = 8  # only has one class (vehicle)
...
#folders_test=['tiny_foggy'] #'tiny_foggy' #, 'snow_1_0' #, 'night_1_4', 'motorway_2_2']
