...
def train(model_name, root_dir, dataset_mode, max_iter):
    ...
    def get_radar_dicts(folders,test=False,total=100):
        ...
        for folder in folders:
            if test:
                radar_folder = os.path.join(root_dir, folder, '20-final-rad-info-polar-test-10/radar-cart-img')
            else:
                radar_folder = os.path.join(root_dir, folder, '20-train_polar-reconst-test-8/radar-cart-img')
